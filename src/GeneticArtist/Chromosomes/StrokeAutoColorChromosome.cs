...
public sealed class StrokeAutoColorChromosome : ChromosomeBase, IChromosomePainter
{
    ...
    public StrokeAutoColorChromosome(
        SKBitmap target,
    ...
    public override IChromosome CreateNew() => new StrokeAutoColorChromosome(
        _target,
        _strokeImages);
